...
public class CreateBDD extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLEENTREPRISE = "CREATE TABLE " + TABLE_ENTREPRISE + " ("+COL_IDENTREPRISE+" INTEGER PRIMARY KEY AUTOINCREMENT,"+ COL_NOMSOCIETE + " TEXT NOT NULL," + COL_ADRESSE + " TEXT NOT NULL," + COL_NUMTELSOCIETE + " TEXT NOT NULL);";
    ...
    private static final String CREATE_TABLEETUDIANT = "CREATE TABLE " + TABLE_ETUDIANT + " ("+COL_IDETUDIANT+" INTEGER PRIMARY KEY AUTOINCREMENT,"+ COL_IDENT_ETUD + " INTEGER," + COL_NOMETUDIANT + " TEXT NOT NULL," + COL_PRENOMETUDIANT + " TEXT NOT NULL," + COL_CLASSE + " TEXT NOT NULL," + COL_ANNEE + " TEXT NOT NULL," + COL_SPECIALITE + " TEXT NOT NULL," + " FOREIGN KEY("+COL_IDENT_ETUD+") REFERENCES " + TABLE_ENTREPRISE + " ("+ COL_IDENTREPRISE+"));";
    ...
    private static final String CREATE_TABLEPROFESSEUR = "CREATE TABLE " + TABLE_PROFESSEUR + " ("+COL_IDPROFESSEUR+" INTEGER PRIMARY KEY AUTOINCREMENT,"+ COL_NOMPROF + " TEXT NOT NULL," + COL_PRENOMPROF + " TEXT NOT NULL," + COL_EMAILPROF + " TEXT NOT NULL, "+ COL_NUMTELPROF + " TEXT NOT NULL);";
